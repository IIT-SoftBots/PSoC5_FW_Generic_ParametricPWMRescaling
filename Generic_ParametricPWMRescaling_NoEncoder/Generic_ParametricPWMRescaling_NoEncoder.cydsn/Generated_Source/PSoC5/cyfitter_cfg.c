...
#define BS_UDB_1_5_0_CONFIG_VAL ((const uint8 CYFAR *)(0x480010ECu + CYAPP_ECC_OFFSET))

/* UDB_1_2_0_CONFIG Address: CYDEV_UCFG_B0_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_2_0_CONFIG_VAL ((const uint8 CYFAR *)(0x4800116Cu + CYAPP_ECC_OFFSET))

/* UDB_0_2_1_CONFIG Address: CYDEV_UCFG_B0_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_2_1_CONFIG_VAL ((const uint8 CYFAR *)(0x480011ECu + CYAPP_ECC_OFFSET))

/* UDB_0_3_1_CONFIG Address: CYDEV_UCFG_B0_P5_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_3_1_CONFIG_VAL ((const uint8 CYFAR *)(0x4800126Cu + CYAPP_ECC_OFFSET))

/* UDB_1_0_0_CONFIG Address: CYDEV_UCFG_B1_P2_U0_BASE Size (bytes): 128 */
#define BS_UDB_1_0_0_CONFIG_VAL ((const uint8 CYFAR *)(0x480012ECu + CYAPP_ECC_OFFSET))

/* UDB_0_1_1_CONFIG Address: CYDEV_UCFG_B1_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)(0x4800136Cu + CYAPP_ECC_OFFSET))

/* UDB_0_0_1_CONFIG Address: CYDEV_UCFG_B1_P5_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_0_1_CONFIG_VAL ((const uint8 CYFAR *)(0x480013ECu + CYAPP_ECC_OFFSET))

/* UCFG_BCTL0 Address: CYREG_BCTL0_MDCLK_EN Size (bytes): 16 */
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)(0x4800146Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)(0x4800147Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x48001484u + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x4800148Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_1 Address: CYREG_PRT1_DR Size (bytes): 10 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x48001494u + CYAPP_ECC_OFFSET))

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)(0x480014A0u + CYAPP_ECC_OFFSET))

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x480014A8u + CYAPP_ECC_OFFSET))

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)(0x480014B4u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM10 Address: CYREG_PHUB_CFGMEM10_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM10_VAL ((const uint8 CYFAR *)(0x480014B8u + CYAPP_ECC_OFFSET))
...
void cyfitter_cfg(void)
{
...

	{
		...
		static const cfg_memset_t CYCODE cfg_memset_list[] = {
			...
			{(void CYFAR *)(CYDEV_UCFG_B0_P0_U1_BASE), 1536u},
